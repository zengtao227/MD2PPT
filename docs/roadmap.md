...
### 1.1 多输入方式 —— 从 URL / 文档提炼 deck.md 骨架

**来源：** pi.inc / DeepVinci 都支持 URL 和文档导入作为 PPT 生成的原始材料。

**现状：** md2ppt 要求用户从零手写 deck.md，摩擦高。

**改进方案：**
在正式写 deck.md 之前，先让 Claude 从原始材料提炼骨架：
...
Claude 的任务：
提炼出 audience、thesis、slide count 和每页 claim 草案
→ 输出为 deck.md 骨架
→ 你确认 / 修改后，进入正式设计和生成流程
```

**实现成本：** 低。一个 Prompt 模板即可，不需要改现有工具。
