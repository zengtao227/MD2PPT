...
# 生成 assets/locks-preview.html，告知用户在浏览器中打开
```

脚本不可用时（非 MD2PPT 目录），直接在对话中展示颜色色块：

| Lock | 背景 · 强调 · 正文 | 结构风格 | 密度 | 适合 |
|------|-------------------|---------|------|------|
| `swiss-klein-blue` | ████`#fafaf8` ████`#002FA7` ████`#0a0a0a` | 瑞士直边网格，权威感 | 中 | 商业计划、投资人、路线图 |
| `linear-dark` | ████`#08090a` ████`#5e6ad2` ████`#f7f8f8` | 工程暗色，紧凑精密 | 中高 | SaaS、技术平台、工程演示 |
| `guizang-indigo` | ████`#f1f3f5` ████`#0a1f3d` ████`#0a1f3d` | 冷调学术，信息密度高 | 高 | 技术方案、数据报告、答辩 |
| `guizang-monocle` | ████`#f1efea` ████`#0a0a0b` ████`#0a0a0b` | 温暖纸感，叙事排版 | 中 | 路演、课程、观点类 |
| `notion-warm` | ████`#ffffff` ████`#37352f` ████`#0d0d0d` | 轻量极简，文档感 | 低 | 内部汇报、文化类、轻量演示 |
